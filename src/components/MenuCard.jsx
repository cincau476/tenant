...
const MenuCard = ({ item, onAvailabilityChange, onDelete, onEdit }) => {
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-105 duration-300">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 pt-4 border-t flex items-center space-x-2">
            <button 
              onClick={onEdit} 
              className="flex-1 flex items-center justify-center text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-3 rounded-lg transition-colors"
            >
